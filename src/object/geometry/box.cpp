...
// 	list.push_back(new xy_rect(p0.x(), p1.x(), p0.y(), p1.y(), p1.z(), ptr));
// 	list.push_back(new flip_normals(new xy_rect(p0.x(), p1.x(), p0.y(), p1.y(), p1.z(), ptr)));
// 	list.push_back(new xz_rect(p0.x(), p1.x(), p0.z(), p1.z(), p1.y(), ptr));
// 	list.push_back(new flip_normals(new xz_rect(p0.x(), p1.x(), p0.z(), p1.z(), p1.y(), ptr)));
// 	list.push_back(new yz_rect(p0.y(), p1.y(), p0.z(), p1.z(), p1.x(), ptr));
// 	list.push_back(new flip_normals(new yz_rect(p0.y(), p1.y(), p0.z(), p1.z(), p1.x(), ptr)));
...
// void box::Sample(hit_record &pos, float probability)
// {
	
// }
// void translate::Sample(hit_record &pos, float probability)
// {
	
// }
// void rotate_y::Sample(hit_record &pos, float probability)
// {
