...
hitable_list test_Load_Models()
{
	...
	material *yellow = new lambertian(new constant_texture(Vector3f(0.85, 0.55, 0.025)));
	material *grass = new lambertian(new constant_texture(Vector3f(0.65, 0.75, 0.05)));
	...
	material *gray = new lambertian(new constant_texture(Vector3f(0.43, 0.43, 0.43)));
	material *green = new lambertian(new constant_texture(Vector3f(0.12, 0.45, 0.15)));
	material *blue = new lambertian(new constant_texture(Vector3f(0.12, 0.15, 0.85)));
	...
	// hit_list.push_back(new models(module_path_list[0], new mental(Vector3f(0.9, 0.9, 0.9), 0.005), models::HitMethod::NAIVE, models::PrimType::TRIANGLE));
...
std::vector<hitable *> gen_sky_box(std::vector<std::string> textures_path, std::vector<hitable *> hit_list, int how_far)
{
	...
	Vector3f cubeVertexList[8] = {
		Vector3f(side_len / 2, side_len / 2, side_len / 2),
		Vector3f(side_len / 2, side_len / 2, -side_len / 2),
		Vector3f(-side_len / 2, side_len / 2, -side_len / 2),
		Vector3f(-side_len / 2, side_len / 2, side_len / 2),
	...
	vertex frontVertexList[4] = {
		{cubeVertexList[0], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)},
		{cubeVertexList[4], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[7], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[3], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)}};

	// nice
	vertex backVertexList[4] = {
		{cubeVertexList[2], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)},
		{cubeVertexList[6], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[5], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[1], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)}};

	vertex leftVertexList[4] = {
		{cubeVertexList[1], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)},
		{cubeVertexList[5], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[4], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[0], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)}};

	vertex rightVertexList[4] = {
		{cubeVertexList[3], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)},
		{cubeVertexList[7], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[6], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[2], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)}};

	vertex upVertexList[4] = {
		{cubeVertexList[0], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[3], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[2], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)},
		{cubeVertexList[1], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)}};

	// nice
	vertex downVertexList[4] = {
		{cubeVertexList[4], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 0, 0)},
		{cubeVertexList[5], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(0, 1, 0)},
		{cubeVertexList[6], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 1, 0)},
		{cubeVertexList[7], Vector3f(0, 0, 0), Vector3f(0, 0, 0), Vector3f(1, 0, 0)}};
...
hitable_list test_Load_complex_Models()
{
	...
	// hit_list.push_back(new sphere(Vector3f(0, 0, -1000), 1000, new lambertian(pertext)); // Ground

	// hit_list.push_back(new sphere(Vector3f(0, 0, 0), 50, new mental(Vector3f(0.8, 0.8, 0.8), 0.5 * drand48()));
	// hit_list.push_back(new sphere(Vector3f(0, 0, 250), 50, blue);

	// hit_list.push_back(new sphere(Vector3f(0, 250, 0), 50, grass);
	// hit_list.push_back(new sphere(Vector3f(250, 0, 0), 50, red);
	...
	// 这里渲染1000面的兔子模型
	// hit_list.push_back(new models(module_path_list[2], new mental(Vector3f(0.8, 0.8, 0.8), 0.01), models::HitMethod::NAIVE, models::PrimType::TRIANGLE));
	// hit_list.push_back(new models(module_path_list[2], new mental(Vector3f(0.8, 0.8, 0.8), 0.01), models::HitMethod::BVH_TREE, models::PrimType::TRIANGLE));
